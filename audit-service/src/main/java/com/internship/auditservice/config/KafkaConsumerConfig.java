...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PolicyEvent> consumerFactory(
        ...
        //allow the event class from specific package only for security purpose
        deserializer.addTrustedPackages("com.internship.auditservice.event");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PolicyEvent> kafkaListenerContainerFactory(ConsumerFactory<String, PolicyEvent> consumerFactory) {
